...
// const Contact = () => {
//     useDocTitle('NM |  - Send us a message')
...
//                         <p className="text-gray-400">Tel: 00000000000</p>
...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        // Form validation logic (if needed) before submission
        // After validation, submit the form to Web3Forms
